...
def auto_save_wdm():
    ...
    while True:
        ...
        try:
            ...
            # 정상 가격 확인
            # ------------------------------------------------
            if wdm_price is not None and float(wdm_price) > 0:
                ...
                print(
                    "[AUTO WDM] "
                    "WDM price unavailable - retry later"
                )
...
def wdm_chart_data():
    ...
    try:
        ...
        # --------------------------------------------------
        # WDM Price History 조회
        # --------------------------------------------------

        rows = get_wdm_price_history(100)
